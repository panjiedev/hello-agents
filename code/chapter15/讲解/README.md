...
| 2 | [agents.md](agents.md) | `backend/agents.py` | 智能体与记忆 | 本章灵魂：好感度 + 记忆检索 + 提示词拼装的六步对话流水线 |
...
1. **状态在 Agent 之外，按需织入提示词**——`SimpleAgent` 本身无状态，NPC 的"人格连续性"全靠运行时把记忆和好感度拼进上下文（agents.md 的洋葱心）；
